...
void Config::load(size_t id) noexcept
{
...

    {
        ...
        if (antiAimJson.isMember("Enabled (might cause Untrusted/VAC auth kick when used in Casual/Deathmatch)")) antiAim.enabled = antiAimJson["Enabled"].asBool();
        ...
        if (antiAimJson.isMember("AA Invert")) antiAim.invert = antiAimJson["Invert"].asInt();
...

    {
        ...
        if (visualsJson.isMember("Nightmode (re-enable when ingame)")) visuals.nightMode = visualsJson["Nightmode (re-enable when ingame)"].asBool();
        ...
        if (visualsJson.isMember("Force rare Deagle animation")) visuals.deagleSpinner = visualsJson["Force rare Deagle animation"].asBool();
        ...
        //if (visualsJson.isMember("Rainbow HUD")) visuals.playerModelT = visualsJson["Rainbow HUD"].asBool();
   ...
   /* {
...

    {
        ...
        if (miscJson.isMember("Slide without LegitAA")) misc.moonwalk = miscJson["Slide without LegitAA"].asBool();
        ...
        if (miscJson.isMember("Overwatch revealer")) misc.revealSuspect = miscJson["Overwatch revealer"].asBool();
        ...
        if (miscJson.isMember("Disable Panorama blur"))  misc.disablePanoramablur = miscJson["Disable Panorama blur"].asBool();
...
void Config::save(size_t id) const noexcept
{
...

    {
        ...
        antiAimJson["Enabled (might cause Untrusted/VAC auth kick when used in Casual/Deathmatch)"] = antiAim.enabled;
...

    {
        ...
        visualsJson["Nightmode (re-enable when ingame)"] = visuals.nightMode;
        {
        ...
        visualsJson["Force rare Deagle animation"] = visuals.deagleSpinner;
...

    {
        ...
        miscJson["Slide without LegitAA"] = misc.moonwalk;
        ...
        miscJson["Overwatch revealer"] = misc.revealSuspect;
        ...
        miscJson["Disable Panorama blur"] = misc.disablePanoramablur;
