...
{
    ImGui::Checkbox("Enabled (might cause Untrusted/VAC auth kick when used in Casual/Deathmatch)", &config->antiAim.enabled);
...
void GUI::renderVisualsWindow() noexcept
{
    ...
    ImGui::Checkbox("No zoom (unfinished)", &config->visuals.noZoom);
    ...
    ImGui::SameLine();
    ImGui::Checkbox("Thirdperson on death", &config->visuals.deadThirdperson);
    ImGui::SameLine();
    ...
    ImGui::Checkbox("Nightmode (re-enable when ingame)", &config->visuals.nightMode);
    ...
    ImGui::PopID();
    ImGui::Checkbox("Force rare Deagle animation", &config->visuals.deagleSpinner);
...
void GUI::renderMiscWindow() noexcept
{
    ...
    ImGui::Checkbox("Slide without LegitAA", &config->misc.moonwalk);
    ...
    ImGui::Checkbox("Overwatch revealer", &config->misc.revealSuspect);
